...
<?php foreach ($chapters as $chapter): ?>
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $chapter['Chapter']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $chapter['Chapter']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $chapter['Chapter']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $chapter['Chapter']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>
