<div id="page-container" class="row">
    <div id="page-content" class="col-sm-12">
        <h2><?php echo __('Adicionar Funcionalidad'); ?></h2>
        <hr>
        <div class="functionalities form">
            <?php echo $this->Form->create('Functionality', array('role' => 'form')); ?>
                <fieldset>
                    ...
                    <div class="form-group col-sm-6">
                        <div class="form-group">
                            <?php echo $this->Form->input('functionality_type_id', array('label' => 'Tipo Funcionalidad *', 'class' => 'form-control')); ?>
                        </div>
                        <div class="form-group">
                            <?php echo $this->Form->input('Role', array('label' => 'Roles *', 'class' => 'form-control')); ?>
                        </div>
                        <div class="form-group">
                            <?php echo $this->Form->input('active', array('label' => 'Activa', 'checked' => true)); ?>
                        </div>
                    </div>
