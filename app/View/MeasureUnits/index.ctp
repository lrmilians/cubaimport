...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="measureUnits index">
			...
			<h2><?php echo __('Measure Units'); ?></h2>
...
<?php foreach ($measureUnits as $measureUnit): ?>
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $measureUnit['MeasureUnit']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $measureUnit['MeasureUnit']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $measureUnit['MeasureUnit']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $measureUnit['MeasureUnit']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>
